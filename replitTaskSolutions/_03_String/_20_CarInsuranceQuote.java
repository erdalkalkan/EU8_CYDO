...
public class _20_CarInsuranceQuote {
...
//        "Invalid data!" and stop the program (use System.exit(0) after displaying warning message to
//        stop the program).
//
...
//        > - If car is for  Commute - add $20 to the premium,
...
//        Make sure that experience is greater than 0 and result of
//        subtraction age from experience is greater or equals to 16.
//        If no, display message: "Invalid data!" and stop the program.
//        Reduce premium on $5 for every year of experience.
//
//        - Then, ask customer about car accidents. Display message:
...
//        you need to insert customer's name.
//        The display message: "Start Your Policy Today For: $premium". Instead of premium,
//        your program should print premium's variable value.
...
//        concatenate first 2 letters of customer's name, age,
//        last 2 letters of of customer's name, zip code, and level of education without spaces.
