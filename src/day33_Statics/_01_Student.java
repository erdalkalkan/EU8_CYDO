...
public class _01_Student {
    ...
    public _01_Student(String name, char gender) {
        this(name);
        this.gender = gender;
    }

    public _01_Student(String name, int studentID) {
        this(name);
        this.studentID = studentID;
    }

    public _01_Student(String name, int studentID, char grade) {
        this(name, studentID);
        this.grade = grade;
    }

    public _01_Student(String name, char gender, int age) {
        this(name, gender);
        this.age = age;
    }

    public _01_Student(String name, char gender, int age, int studentID) {
        this(name, gender, age);
        this.studentID = studentID;
    }

    public _01_Student(String name, char gender, int age, int studentID, char grade) {
