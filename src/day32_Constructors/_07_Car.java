...
public class _07_Car {
    ...
    public _07_Car(String brand){
        this.brand = brand;
    }

    public _07_Car(String brand, String model){
        this(brand);
        this.model = model;
    }

    public _07_Car(String brand, String model, int year){
        this(brand, model);
        this.year = year;
    }

    public _07_Car(String brand, String model, int year, double price) {
        this(brand, model, year);
        this.price = price;
    }

    public _07_Car(String brand, String model, int year, double price, String color) {
